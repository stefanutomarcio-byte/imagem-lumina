...
1. **WhatsApp** — já configurado com o número (16) 98170-3277 em `assets/js/lumina.js` (`wa:'5514991194057'`). Quando migrar para um número business, basta trocar essa linha.
